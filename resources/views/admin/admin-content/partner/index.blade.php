    ...
    <table id="example" class="display" style="width:100%">
        ...
        @foreach($partners as $testimonial)
            <tr>
                ...
                <td><a href="{{ route('partner.edit',$testimonial->id) }}" class="btn btn-info">Update</a></td>
                <td>
                    <form action="{{ route('partner.destroy',$testimonial->id) }}" method="post">
                        {{ csrf_field() }}
                        @method('delete')
