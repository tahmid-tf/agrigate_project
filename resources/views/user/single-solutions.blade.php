    ...
    <div class="containers">
        <div class="row ml-0 mr-0">
            <div class="col-lg-4" id="">
                ...
                <div class="agrigate-text bottom-right-2">Bottom Right</div>
            </div>
            <div class="col-lg-8" style="margin-top:220px;">
                <div class="" style="margin-left: -660px">
                    <p class="agrigate-text">Buy and Sell Products</p>
                    <p class="agrigate-text">Buy and Sell Products</p>
                    <p class="agrigate-text">Buy and Sell Products</p>
                </div>
            </div>
