        ...
        <div class="row ml-0 mr-0">
            ...
            <div class="col-lg-8 col-md-6  col-agrigate">
                <div class="agrigate-styles">
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-10') }}">Bank A/C Opening</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-11') }}">Agri Loan for Farmers</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-12') }}">Crop Insurance</a></p>
                </div>
            </div>
        </div>
    </div>
