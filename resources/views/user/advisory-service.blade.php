        ...
        <div class="row ml-0 mr-0">
            ...
            <div class="col-lg-8 col-md-6  col-agrigate">
                <div class="agrigate-styles">
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-5') }}">Production Technology</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-6') }}">Advisory Consultation</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-7') }}">Best Practices</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-8') }}">Weather Information</a></p>
