    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-interval="false">
        <ol class="carousel-indicators">
            ...
            @foreach($sliders as $banner)
                    <?php $id_1 += 1; ?>
                @if($id_1 == 1)
                    <li data-target="#carouselExampleIndicators" data-slide-to="{{ $id_1 }}" class="active"></li>
                @else
                    <li data-target="#carouselExampleIndicators" data-slide-to="{{ $id_1 }}"></li>
                @endif
            @endforeach
        </ol>
            ...
            @foreach($sliders as $banner)
                ...
                @if($id == 1)
                    <div class="carousel-item active">
                        ...
                        <span
                            style="display: none">{{ $type_file = pathinfo(asset('storage/'.$banner->image),PATHINFO_EXTENSION) }}</span>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('source') }}"><img src="{{ asset('images/image 2.png') }}"
                                                     class="d-block mx-auto img-fluid"></a>
                <a href="{{ route('source') }}">
                    <p class="text-center top-section-text-style">@lang('home.Source from Us')</p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('work') }}"><img src="{{ asset('images/image 3.png') }}"
                                                   class="d-block mx-auto img-fluid"></a>
                <a href="{{ route('work') }}">
                    <p class="text-center top-section-text-style">@lang('home.Work with Us')</p>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('solutions') }}"><img src="{{ asset('images/image 1.png') }}"
                                                        class="d-block mx-auto img-fluid"></a>
                <a href="{{ route('solutions') }}">
                    <p class="text-center top-section-text-style">@lang('home.Grow with Us')</p>
                </a>
            </div>
        </div>
    </div>
                                ...
                                <div class="flip-card">
                                    <div class="flip-card-inner">
                                        <div class="flip-card-front">
                                            <img src="{{ asset('storage/' . $goal->image) }}" class="img-card"
                                                 alt="">
                                        </div>
                                        <div class="flip-card-back"
                                             style="background-color: {{ $goal->hex_color }};">
                                            <div class="container">
...
<section class="section-light-green-bg py-4">
    <p class="text-center heading-text-style-2" style="margin-top: -35px">@lang('home.Facts & Figures/(Our Impact)')</p>
    <section class="section-dark-green-bg py-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-2 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-1.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-2 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-2.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-2 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-3.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-2 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-4.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-2 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-5.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-2 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-6.png') }}"
                             alt="">
                        <div class="card-body">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-3 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-7.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-8.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-9.png') }}"
                             alt="">
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card facts-card">
                        ...
                        <img class="card-image-top img-fluid" src="{{ asset('images/facts-10.png') }}"
                             alt="">
                        <div class="card-body">
                            <p class="card-bottom-text">4.5 Cr. BDT</p>
                        </div>
                    </div>
                </div>
                        ...
                        <article class="card project-card thumbnail item mb-4"
                            ...
                            <div class="caption p-4">
                                <h4 class="card-subheading">
                                    {{ \App\User::language_change($testimonial->title_en, $testimonial->title_bn) }}
                                </h4>
                                <p class="card-text">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card-body mt-3">
                            <h5 class="subtext-style">
                                {{ \App\User::language_change($news->title_en, $news->title_bn) }}</h5>
                            <a href="{{ route('single-news', $news->id) }}" class="read-more">
                                <p>Read more...</p>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <img src="{{ asset('storage/' . $news->image) }}"
                             class="news-image px-2 mt-4 mb-4 img-fluid">
                    </div>
                </div>
            </div>
        @endforeach
