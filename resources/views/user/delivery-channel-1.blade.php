    ...
    <div class="containers">
        <div class="row ml-0 mr-0">
            <div class="col-lg-4 col-md-6 " id="">
                ...
                <div class="agrigate-text bottom-right-2" style="font-size:18px">{{ $var_primary }}</div>
            </div>
            <div class="col-lg-8 col-md-6  col-agrigate">
                <div class="agrigate-styles">
                    <p class="agrigate-text">{{ $var1 }}</p>
                    <div class="agrigate-text">
                        <img src="{{ asset('images/agrigate.png') }}" class="img-fluid" style="width:30px;height:30px;">
