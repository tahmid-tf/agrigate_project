        ...
        <div class="row ml-0 mr-0">
            ...
            <div class="col-lg-8 col-md-6  col-agrigate">
                <div class="agrigate-styles">
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-1') }}">Buy products</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-2') }}">Sell products</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-3') }}">Market Price Info</a></p>
                    <p class="agrigate-text"><a href="{{ route('delivery-channel-4') }}">Input Distribution</a></p>
