...
class NewsController extends Controller
{
    ...
    {
        $news = News::all();
        return view('admin.admin-content.news.index', compact('news'));
    }
    ...
    {
        return view('admin.admin-content.news.create');
    }
    ...
    {
        return view('admin.admin-content.news.edit',compact('news'));
    }
